									...
									case 3:
										...
										for (BooksInfo bookBean : bookauthor) {
											if (bookBean != null) {
												...
												System.out.println("No books are available with this authorname");
											}
										}
										break;
									...
									case 9:
										try {
											...
											for (StudentInfo infos : StudentInfos) {
												System.out.println(String.format("%-10s %-10s %s", infos.getId(),
														infos.getName(), infos.getEmail()));
											}
										} catch (Exception e) {
											System.out.println("None of the students are registered in the library");
										}
										break;
								...
								do {
									...
									case 5:
										...
										try {
											...
											System.out.println(
													"<--------------------------------------------------------------------->");
											System.out.println(String.format("%-10s %-10s %-10s %s", "STUDENT-ID",
													"STUDENT-NAME", "BOOK-ID", "BOOK-NAME"));
									...
									case 6:
										...
										try {
											...
											System.out.println(
													"<------------------------------------------------------------------>");
											System.out.println(String.format("%-10s %-10s %s", "STUDENT-ID", "BOOK-ID",
													"IS BOOK RETURNED"));
											System.out.println(String.format("%-10s %-10s %-10s %s",
													requestInfo.getStudentInfo().getId(),
													requestInfo.getBookInfo().getBookId(), requestInfo.isReturned()));
										} catch (Exception e) {
